  ...
  return (
    <NavigationMenuList>
      <NavigationMenuItem className="relative">
        <NavigationMenuTrigger className="sm:text-xs md:text-sm lg:text-sm xl:text-sm 2xl:text-sm backdrop-blur-sm bg-transparent rounded-full">
          Profile
        </NavigationMenuTrigger>
        <NavigationMenuContent className="absolute backdrop-blur-sm bg-transparent rounded-full">
          <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
            ...
            {admin && logedin && (
              <ListItem href="/create" title="Create Article" />
            )}
            {logedin ? (
